		...
		<div id="homepage">
			...
			<section id="sectionTwo" class = "py-5">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h5 class="midline"><span class = "sofia maroon"><?php echo $sectionTwo['header']; ?></span></h5>
						</div><!-- .col-sm-12 -->
						<?php $testimonials = $sectionTwo['testimonials'];							
						    foreach( $testimonials as $post ): 
						        ...
						        <div class="testimonial col-lg-4">
						        	...
						        	<h5 class = "mb-2 maroon oswald"><?php the_field('callout'); ?></h5>
							            ...
							            <h6>~ <?php the_field('attribution'); ?></h6>
						        </div><!-- .testimonial -->
						    <?php endforeach; 
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							...
							<a href = "<?php echo $sectionThree['button_link']; ?>"><button role = "button" class = "btn mt-3"><?php echo $sectionThree["button_text"]; ?></button></a>
						</div><!-- .col-lg-6 -->
				</div><!-- .container -->
			</div><!-- #sectionThree -->
