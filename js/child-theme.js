...
(function (global, factory) {
	...
	*/
	...
	jQuery(function ($) {
	  ...
	  $('.hero .content-wrapper').css('margin-top', headerHeight / 2 + 'px'); //Smooth scroll behavior for jump links
	  ...
	  if ($(window).width() >= 992) {
	    ...
	    $('#otherSpecialties #sectionTwo .image-wrapper').css('position', 'absolute'); //Force the image to be the width of column plus the gutter
